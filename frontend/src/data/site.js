...
export const events = [
  {
    ...
    coordinators: [
      { name: 'Abilash B', phone: '7200467850' },
      { name: 'Jaie Balaji T', phone: '9080039771' }
    ],
  },
  {
    id: 'bug-hunt',
  ...
  },
  {
    ...
    details: [
      ...
      'Work together as a team of 2-4 members.',
    ...
    coordinators: [
      { name: 'Madhumitha A', phone: '9789339084' },
  ...
  },
  {
    ...
    imagePosition: 'center center',
    format: 'Team Cricket strategy event with two rounds: Rapid Fire and IPL Auction. Participants compete to build a strong 15-player squad using a ₹120 Crore budget.',
    details: [
  ...
  },
  {
    ...
    imagePosition: 'center center',
    format: 'An intensive hands-on offensive & defensive cybersecurity workshop uncovering real-world exploit vectors, ethical hacking techniques, and live labs by GAMKERS.',
    details: [
