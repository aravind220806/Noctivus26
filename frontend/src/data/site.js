...
export const events = [
  {
    ...
    format: 'A solo cybersecurity challenge where participants solve problems and find flags using ethical security techniques.',
    details: [
  ...
  },
  {
    ...
    details: [
      ...
      'Sharing flags, payloads, or prompts between participants is forbidden.',
  ...
  },
  {
    ...
    imagePosition: 'center center',
    format: "Present one original idea using the official PPT template. Each participant gets 5–6 minutes for the pitch and 2–3 minutes for judges' Q&A.",
    details: [
      'Use the official PPT template.',
      'Each participant can present only one idea.',
      'Solo registration only.',
      'Multiple-member teams are not allowed.',
      ...
      'Participants should be ready to take part in the presentation and Q&A.',
  ...
  },
  {
    ...
    details: [
      ...
      'Work individually.',
      'Do not share answers or clues with other participants.',
  ...
  },
  {
    ...
    imagePosition: 'center center',
    format: 'A solo cricket strategy event with two rounds: Rapid Fire and IPL Auction. Participants compete to build a strong 15-player squad using a ₹120 Crore budget.',
    details: [
      'Solo registration only.',
      'The first round is Rapid Fire.',
      'Top 10 participants qualify for the auction round.',
      'Each participant gets a ₹120 Crore budget.',
