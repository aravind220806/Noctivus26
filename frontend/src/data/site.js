...
export const events = [
  {
    ...
    details: [
      'Bringing a personal laptop and charger is mandatory for all participants.',
      'Participants must ensure that their laptop is fully charged and ready before the event.',
...
export const timeline = [
  ...
  ['09:30 AM', 'Technical events begin', 'CTF, Bug Hunt, Prompt Heist, Secure X Vibe Coding, and IGNITE move into round one.'],
