...
export const events = [
  ...
  },
  {
    ...
    details: [
      ...
      'Regristrations should be done individually',
  ...
  },
  {
    ...
    imagePosition: 'center center',
    format: 'Team based Cricket strategy  event with two rounds: Rapid Fire and IPL Auction. Participants compete to build a strong 15-player squad using a ₹120 Crore budget.',
    details: [
