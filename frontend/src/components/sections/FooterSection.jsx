    ...
    <footer className="footer-cyber-hud" id="footer">
      ...
      <div className="footer-hud-container">
        ...
        <div className="footer-content-layout">
          ...
          {/* LEFT & MIDDLE: Compact Google Map + Venue / Contact / Bus Route */}
          <div className="footer-venue-details-wrap">
            
            {/* Small Compact Dark Map */}
          ...
          <div className="footer-social-side">
            <h4 className="footer-social-title">CONNECT_</h4>
