...
def build_overview(registrations: list[dict]) -> dict:
    statuses = {"pending": 0, "confirmed": 0, "mismatch": 0, "duplicate": 0}
    events = {
        event["id"]: {"eventId": event["id"], "eventName": event["name"], "category": event["category"], "registrations": 0, "confirmed": 0, "pending": 0, "revenue": 0}
